...
export interface Segment { id: string; automatic_speaker_id: string; ordinal: number; content: string; correction?: string | null; start_time_ms: number; end_time_ms: number; }
