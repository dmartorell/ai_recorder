...
export interface Speaker { id: string; provider_label: string; ordinal: number; editorial_id?: string; automatic_speaker_id?: string | null; name: string | null; }
export interface Segment { id: string; automatic_speaker_id: string; ordinal: number; content: string; correction?: string | null; speakerCorrectionID?: string | null; start_time_ms: number; end_time_ms: number; }
